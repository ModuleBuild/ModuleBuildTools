# Run this in an administrative PowerShell prompt to install the ModuleBuildTools PowerShell module:
#
# iex (New-Object Net.WebClient).DownloadString("https://github.com/ModuleBuild/ModuleBuildTools/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'ModuleBuildTools'
$DownloadURL = 'https://github.com/ModuleBuild/ModuleBuildTools/raw/master/release/ModuleBuildTools-current.zip'
